-- Linting: nvim-lint — loaded on the first real buffer
local pack = require("core.pack")

pack.lazy({ "https://github.com/mfussenegger/nvim-lint" })
...
local function setup()
  ...
  -- ══════════════════════════════════════════════════════════════════════════
  -- Auto-lint (debounced; skip oversized files)
  -- ══════════════════════════════════════════════════════════════════════════
...
pack.load_on("BufReadPre", "nvim-lint", setup)
pack.load_on("BufNewFile", "nvim-lint", setup)
