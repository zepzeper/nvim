...
local function get_virtual_text_color()
    if require("zepzeper.native.lsp").virtual_diagnostics then
        return { fg = green }
    end
    return icon_hl
end
...
local function get_format_enabled_color()
    if require("zepzeper.native.lsp").format_enabled then
        return { fg = green }
    end
    return icon_hl
end
...
local function get_zen_mode_color()
    if require("zepzeper.plugins.no-neck-pain").enabled then
        return { fg = green }
    end
    return icon_hl
end
